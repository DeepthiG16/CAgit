package ComprehensiveAssessment.Automation;
	...
	public class automation2 {
		...
		public static void main(String[] args) throws InterruptedException,IOException {
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("(//*[@aria-label='button'])[4]")).click();
			
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='login-email']")).click();
			driver.findElement(By.xpath("//*[@id='login-email']")).sendKeys("deepthigurumurthi@gmail.com");
			
			driver.findElement(By.xpath("//*[@id='login-password']")).click();
			driver.findElement(By.xpath("//*[@id='login-password']")).sendKeys("Ruby@1606");
